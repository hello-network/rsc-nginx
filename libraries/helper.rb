...
module RsApplicationNginx
  # This module contains helper methods for rsc-nginx cookbook.
  #
  module Helper
    ...
    def self.get_bind_ip_address(node)
      case node['rsc-nginx']['bind_network_interface']
      when "private"
      ...
      when "public"
        ...
        raise "Unknown network interface '#{node['rsc-nginx']['bind_network_interface']}'!" +
